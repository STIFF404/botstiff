...
───────────────────────`
            ...
            break
            case 'bot': case 'BOT': {
            let stiff = `*Apasi Anjing, Panggil Gua!!*`
            let me = m.sender
            await naze.sendText(m.chat, stiff, m)
            }
            break
            case 'anj': case 'anjing': case 'kontol': case 'tolol': {
            let anj = `*Sopan bang, Jangan kasar begitu anjing*`
            let me = m.sender
            await naze.sendText(m.chat, anj, m)
            }
            break
            case 'mgroup': {
goup = `*Group Menu*
