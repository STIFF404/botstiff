...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'anj': case 'kontol': case 'tai': case 'anjing'{
                m.reply('jangan kasar begitu bang')
            }
            break
            case 'bot':{
                m.reply('Apaan panggil gua anj!!!')
            }
            break
            case 'sc': {
...
`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
