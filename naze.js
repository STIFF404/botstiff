...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `Ciee yang Jadian💖 Jangan lupa Donasi Ke *OmStiff*🗿
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            await naze.sendButtonText('6283879685072@s.whatsapp.net', buttons, pjtxt, nyoutube, m, {mentions: ments})
...
//PEMBATAS=======================================
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
            ...
            /*case 'tiktok': case 'tiktoknowm': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(`https://api-xcoders.site/api/download/tiktok2?url=${text}&apikey=UsVECoPOnG`)
                let buttons = [
            ...
            /*case 'tiktok': case 'tiktoknowm': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(`https://api-xcoders.site/api/download/tiktok2?url=${text}&apikey=UsVECoPOnG`)
                let buttons = [{buttonId: `menu`, buttonText: {displayText: '🗿menu'}, type: 1},{buttonId: `donasi`, buttonText: {displayText: 'donasi🙂'}, type: 1}]
                let buttonMessage = {
                    video: { url: anu.result.nowatermark },
                    caption: `Download From ${text}`,
                    footer: 'Press The Button Below',
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                naze.sendListMsg(m.chat, `pilih aja *ayang* Setmenu nya!`, naze.user.name, `*Hello Ayang* !`, `Pilih Ayang`, sections, m)
                }
            }
            break
            /*case 'sponsor': {
...
-Creator :  @${ownernya.split('@')[0]}\n-Lu : @${me.split('@')[0]}\n-Powered  : @${ini_mark.split('@')[0]}\n- :  @${qontak.split('@')[0]}\n- :  @${dana.split('@')[0]}\n- :  @${shopeeotp.split('@')[0]}\n- :  @${shopee.split('@')[0]}\n- :  @${tokopedia.split('@')[0]}\n- :  @${smartfrend.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${facebook.split('@')[0]}\n- :  @${pasarpolis.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${kominfo.split('@')[0]}\n- :  @${alfamart.split('@')[0]}`
            ...
            break*/
            case 'bot': case 'Bot': {
            await naze.sendText(m.chat, `Apa anjirr🗿`, m)
            }
            break
            case 'ayang': {
            if (!isCreator) throw mess.owner
            await naze.sendText(m.chat, `iya ayangku😘`, m)
            }
            break
            case 'linktiktok': {
            await naze.sendText(m.chat, `https://tiktok.com/@omstiff404`, m)
            }
            break
            case 'cintaku': {
            if (!isCreator) throw mess.owner
            await naze.sendText(m.chat, `iya ada apa cintaku😘`, m)
            }
            break
            case 'lovyu': {
            if (!isCreator) throw mess.owner
            await naze.sendText(m.chat, `i love you too ayang😘`, m)
            }
            break
            ...
            await naze.sendText(m.chat, `Jangan kasar begitu bang, Nanti ayangku marah loh, iyakan ayang😠`, m)
            }
            break
            case 'iyaayng': case 'iyaayang': case 'iya': {
            if (!isCreator) throw mess.owner
            await naze.sendText(m.chat, `nah kan🤭`, m)
            }
            break
            case 'bukaa': {
            if (!isCreator) throw mess.owner
            await naze.sendText(m.chat, `jangan ayang ah dosa loh😏`, m)
            }
            break
            case 'okelah': {
            if (!isCreator) throw mess.owner
            await naze.sendText(m.chat, `nah begitu dong, aku makin sayang ama kamu🥰`, m)
            }
            break
            /*case 'menu': {
            let ownernya = ownernomer + '@s.whatsapp.net'
...
`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'Menu' }, type: 1 },{ buttonId: 'linktiktok', buttonText: { displayText: 'TikTok' }, type: 1 }]
...
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            ...
            break*/
            case 'mdownloader': {
dwnloader = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, dwnloader, tiktokx, m)
            }
            break
            case 'msearch': {
sarch = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, sarch, msrh, m)
            }
            break
            case 'mrandom': {
rndom = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, rndom, mxxr, m)
            }
            break
            /*case 'mtextpro': {
...
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            ...
            break*/
           case 'mfun': {
mun = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, mun, funxx, m)
            }
            break
            /*case 'mprimbon': {
pimbon = `┌──⭓ *Primbon Menu*
...
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            ...
            break*/
            case 'mconvert': {
cnvert = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, cnvert, conzzz, m)
            }
            break
            case 'mmain': {
min = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, min, mainzz, m)
            }
            break
            case 'mdatabase': {
dtbase = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, dtbase, dtzzz, m)
            }
            break
            /*case 'manonymous': {
...
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            ...
            break*/
            case 'mislamic': {
islmic = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, islmic, islamz, m)
            }
            break
case 'mvoice': {
vice = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, vice, vicezz, m)
            }
            break
            case 'mowner': {
oner = `${jamturu} ${pushname}`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, oner, werzz, m)
            }
            break
            /*case 'allmenu': {
            let ownernya = ownernomer + '@s.whatsapp.net'
            ...
            await naze.sendButtonText(m.chat, buttons, anu, ssmenu, m, {mentions: ments})
            }
            break*/
            case 'sound1':
case 'sound2':
...
naze.sendMessage(from, {sticker:sendNye, contextInfo:{forwardingScore: 800, isForwarded: true}}, {quoted:m})
}
//anti-tag 3
